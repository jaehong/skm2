/*
    ...
    Plik zawiera funkcj�crc16 obliczajc crc 16 bitowe.
    Dodatkowo jeli jest zdefiniowana staa:
        GENERATE - kompilowana jest funkcja main generujca tablic�dla szybkiego obliczania CRC
                   (polinominal)
        TEST - kompilowana jest funkcja main testujca oblicznie CRC dla polinominal x^15 + 1
*/
//#include <stdafx.h>
#include "crc.h"
//#define TEST
